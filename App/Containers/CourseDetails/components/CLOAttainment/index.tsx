...
import { useClassCloAttainmentQuery } from '../../../../RTK/Api/CourseApi';
import colors from '../../../../Themes/Colors';
import { useLanguage } from '../../../../Types/LanguageContext';
import { findWord } from '../../../../Utils/ParsingUtils';
import { CLOAttainmentDetails, CLOGraph } from './component';
import styles from './styles';
const CLOAttainment = (props: any) => {
  var id = props.route.params.id;
  const { data, refetch, isFetching, isLoading, isError } =
    useClassCloAttainmentQuery({ id: id || 0 });
  ...
  if (data.length === 0) {
    return <NoResults message="No CLO Attainment Found" />;
  }
